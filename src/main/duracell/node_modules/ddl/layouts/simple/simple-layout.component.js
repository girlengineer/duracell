...
var simple_layout_settings_1 = require('./simple-layout.settings');
/**
...
var SimpleLayoutComponent = (function () {
    function SimpleLayoutComponent() {
        ...
        this.settings = new simple_layout_settings_1.SimpleLayoutSettings;
    ...
    Object.defineProperty(SimpleLayoutComponent.prototype, "theme", {
        /**
         * @Property: theme
    ...
    Object.defineProperty(SimpleLayoutComponent.prototype, "customerType", {
        /**
    ...
    SimpleLayoutComponent.prototype.ngAfterViewChecked = function () {
    ...
    ], SimpleLayoutComponent.prototype, "theme", null);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String), 
        __metadata('design:paramtypes', [String])
    ], SimpleLayoutComponent.prototype, "customerType", null);
    SimpleLayoutComponent = __decorate([
        core_1.Component({
            selector: 'citi-simple-layout',
            template: require('./simple-layout.component.html')
        }), 
