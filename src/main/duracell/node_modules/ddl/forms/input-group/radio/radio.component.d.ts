...
export declare class RadioComponent implements OnInit {
    ...
    constructor(inputService: InputService, validationService: ValidationService);
    input: ElementRef;
    ...
    /**
     * @Property: id
     * @Description: The id for the checkbox
     * @Type: String
     */
    idStr: string;
    /**
     * @Property: name
     * @Description: The name for the checkbox
     * @Type: String
     */
    name: string;
    /**
    ...
    /**
     * @Property: error
     * @Description: If the checkbox is in an error state
     * @Type: Boolean
     */
    error: boolean;
