...
:host /deep/ .datepicker-container {
...
:host /deep/ .datepicker-container .datepicker-input-container {
    display: inline-block; 
...
:host /deep/ .datepicker-input-container.is-expandedBelow {
...
:host /deep/ .datepicker-container .datepicker-input {
    display: inline-block;
    height: 42px;
    max-width: 310px;
    width: 85%;
...
:host /deep/ .datepicker-container .datepicker-input-container .datepicker-input-icon {
    display: inline-block; 
}
:host /deep/ .datepicker-container .datepicker-input-container .datepicker-input-icon i {
    font-size: 20px;
    cursor: pointer; 
}
...
:host /deep/ .datepicker-container .datepicker-calendar {
...
:host /deep/ .datepicker-container .datepicker-calendar .datepicker-calendar-container {
    padding: 10px; 
}

/* Month Section */

:host /deep/ .datepicker-container .datepicker-calendar .datepicker-calendar-container .datepicker-calendar-month-section {
    width: 100%;
    display: flex;
...
:host /deep/ .datepicker-container .datepicker-calendar .datepicker-calendar-container .datepicker-calendar-month-section i {
    cursor: pointer; 
}

:host /deep/ .datepicker-container .datepicker-calendar .datepicker-calendar-container .datepicker-calendar-month-section i:first-child {
    margin-left: 12px; 
}

:host /deep/ .datepicker-container .datepicker-calendar .datepicker-calendar-container .datepicker-calendar-month-section i:last-child {
    margin-right: 12px; 
}
...
:host /deep/ .datepicker-container .datepicker-calendar .datepicker-calendar-container .datepicker-calendar-day-names {
    width: 320px;
    position: relative;
    top: 20px;
}

:host /deep/ .datepicker-container .datepicker-calendar .datepicker-calendar-container .datepicker-calendar-day-names span {
    font-weight: bold;
    display: block;
    float: left;
    width: calc(100% / 7);
...
:host /deep/ .datepicker-container .datepicker-calendar .datepicker-calendar-container .days-container {
    width: 320px;
    margin-top: 60px;
}
...
:host /deep/ .days-container span.day:hover {
    border: 2px solid #056DAE;
    border-radius: 15%;
}

:host /deep/ .days-container span.selected {
    background-color: #056DAE;
    color: #fff !important;
    border-radius: 15%;
}

:host /deep/ .days-container span.today {
    color: #000;
    font-weight: bold;
}
...
:host /deep/ .datepicker-container .datepicker-calendar .datepicker-calendar-container .ui-datepicker-close {
    margin: 5px auto 0px;
    display: block;
    float: none;
    background: 0 0;
...
:host /deep/ .datepicker-container .datepicker-calendar .datepicker-calendar-container .ui-datepicker-close:hover {
    text-decoration: underline;
}

:host /deep/ .datepicker-container .datepicker-calendar .datepicker-calendar-container .datepicker-close-button {
    width: 100%;
    display: inline-block;
    color: #056DAE;
    cursor: pointer;
